...
ActiveRecord::Schema[8.1].define(version: 2026_07_29_101957) do
  ...
  create_table "content_activities", force: :cascade do |t|
    ...
    t.index ["hour_of_activity"], name: "index_content_activities_on_hour_of_activity"
  end
  ...
  create_table "hashtag_activities", force: :cascade do |t|
    ...
    t.index ["hour_of_activity", "language"], name: "index_hashtag_activities_on_hour_of_activity_and_language"
  end
  ...
  create_table "link_activities", force: :cascade do |t|
    ...
    t.integer "trend_signals", default: 0, null: false
    t.datetime "updated_at", null: false
    t.index ["hour_of_activity", "language"], name: "index_link_activities_on_hour_of_activity_and_language"
